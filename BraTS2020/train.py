...
class BraTSTrainer(Trainer):
    ...
    def validation_end(self, mean_val_outputs):
        ...
        if mean_dice > self.best_mean_dice:
            ...
            save_new_model_and_delete_last(self.model, os.path.join(model_save_path, f"best_model_{mean_dice:.4f}.pt"), delete_symbol="best_model")
        save_new_model_and_delete_last(self.model, os.path.join(model_save_path, f"final_model_{mean_dice:.4f}.pt"), delete_symbol="final_model")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--not_call_launch", action='store_true', help="Do not call launch function inside the script")
